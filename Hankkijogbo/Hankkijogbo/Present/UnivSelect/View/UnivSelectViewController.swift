...
extension UnivSelectViewController: UICollectionViewDelegate {
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        SetupAmplitude.shared.logEvent(AmplitudeLiterals.UnivSelect.tabSubmit, eventProperties: ["university_name": viewModel.universityList[viewModel.currentUnivIndex].name])
