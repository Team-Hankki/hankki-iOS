...
final class ZipViewController: BaseViewController {
    ...
    override func setupStyle() {
        ...
        shareButton.do {
            ...
            $0.setAttributedTitle(UILabel.setupAttributedText(for: PretendardStyle.body3, withText: "공유하기", color: .hankkiWhite), for: .normal)
            
            var configuration = UIButton.Configuration.tinted()
            configuration.contentInsets = NSDirectionalEdgeInsets(top: 10, leading: 9, bottom: 10, trailing: 16)
    ...
    override func setupLayout() {
        ...
        headerImageView.snp.makeConstraints {
            ...
            $0.height.equalTo(
                UIView.convertByAspectRatioHeight(view.frame.width - 22 * 2,
...
extension ZipViewController: UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(
            withReuseIdentifier: ZipCollectionViewCell.className,
            for: indexPath
        ) as? ZipCollectionViewCell else { return UICollectionViewCell() }
